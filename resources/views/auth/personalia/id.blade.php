        ...
        <div class="row">
            <div class="col-md-3" data-aos="fade-up">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="id.php">Step 3: ID's</a>
                    </li>
                    <li class="nav-item ">
                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="passport-tab" data-bs-toggle="tab"
                                ...
                                aria-selected="true">Passport & Visas
                                Information</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="Employees-tab" data-bs-toggle="tab" data-bs-target="#Employees"
                                type="button" role="tab" aria-controls="Employees" aria-selected="false">Drivers
                                License</button>
                        </li>
                    </ul>
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active mt-3" id="passport" role="tabpanel"
                            ...
                            <form action="forms/contact.php" method="post" role="form" class="php-email-form">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 form-group mt-3 mt-md-0">
                                        <label for="givenname">Type of Primary Passport</label>
                                        <select class="form-control" aria-label="Default select example">
                                            <option selected>Select One ...</option>
                                            <option value="1">Service Passport</option>
                                            <option value="2">Student Passport</option>
                                            <option value="3">E-passport</option>
                                            <option value="4">Regular Passport</option>
                                            <option value="5">Special Passport</option>
                                            <option value="5">Diplomatic Passport</option>
                                            <option value="6">Temporary Passport</option>
                                        </select>
                                    </div>
                                    <div class="col-md-6 form-group mt-3 mt-md-0">
                                    ...
                                    <div class="col-md-12 form-group mt-3">
                                        <label for="name">Issuing Authority</label>
                                        <input type="text" class="form-control" name="subject" id="subject" required>
                                    </div>
                                    ...
                                    <div class="col-md-6 form-group mt-3">
                                        <label class="form-label" for="customFile">Front Picture</label>
                                        <input type="file" class="form-control" id="customFile" />
                                    </div>
                                    <div class="col-md-6 form-group mt-3">
                                        <label class="form-label" for="customFile">Back Picture</label>
                                        <input type="file" class="form-control" id="customFile" />
                                    </div>
                                </div>
                            </form>
                        ...
                        <div class="tab-pane fade mt-3" id="Employees" role="tabpanel" aria-labelledby="Employees-tab">
                            <form action="forms/contact.php" method="post" role="form" class="php-email-form">

                                <div class="row">

                                    <div class="col-md-6 form-group mt-3 mt-md-0">
                                        <label for="givenname">Type of Drivers License</label>
                                        <select class="form-control" aria-label="Default select example">
                                            <option selected>Select One ...</option>
                                            <option value="1">Service Passport</option>
                                            <option value="2">Student Passport</option>
                                    ...
                                    <div class="col-md-12 form-group mt-3">
                                        <label for="name">Drivers License Number</label>
                                        <input type="text" class="form-control" name="subject" id="subject" required>
                                    </div>
                                    <div class="col-md-12 form-group mt-3">
                                        <label for="name">Issuing Authority</label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-auto">
                                            <a class="btn btn-primary d-block w-100 {{ (request()->is('insurance')) ? 'active' : '' }}" href="{{ route('insurance') }}">Continue</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
