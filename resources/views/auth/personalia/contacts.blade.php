            ...
            <div class="col-md-9 mb-5 mb-md-0" order-2 data-aos="fade-up">
                <form action="forms/contact.php" method="post" role="form" class="php-email-form">
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade mt-3" id="insurance" role="tabpanel" aria-labelledby="insurance-tab">
                            <form action="forms/contact.php" method="post" role="form" class="php-email-form">

                                <div class="row">
                                    <div class="col-md-12 form-group">
                                        <label for="name">Medical Insurance Name</label>
                                        <input type="text" name="name" class="form-control" id="name" required>
                                    </div>
                                    ...
                                    <div class="col-md-4 form-group mt-3">
                                        ...
                                        <input type="text" class="form-control" name="postal2" id="postal2" required>
                                    </div>
                                    <div class="col-md-4 form-group mt-3">
                                        <label for="name">Province</label>
                                        <input type="text" class="form-control" name="province" id="province" required>
                        ...
                        <div class="tab-pane fade mt-3" id="primary" role="tabpanel" aria-labelledby="primary-tab">
                            <form action="forms/contact.php" method="post" role="form" class="php-email-form">
                                ...
                                <div class="row">
                                    ...
                                    <div class="row mt-5">
                                        ...
                                        <div class="col-auto"><a class="btn btn-primary d-block w-100 {{ (request()->is('id')) ? 'active' : '' }}" href="{{ route('id') }}">Continue</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
